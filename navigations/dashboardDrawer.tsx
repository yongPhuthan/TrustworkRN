...
const commonScreenOptions = {
  ...
  const borderRadius = 3; // Adjust as needed
    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={{ paddingTop: 20, paddingBottom: 20,paddingLeft:20, backgroundColor: '#ffffff', alignItems: 'flex-start' }}>
        ...
        <PaperDrawer.Section >
          <PaperDrawer.Item
            ...
            style={props.state.index === 0 ? { backgroundColor: activeTintColor, borderRadius: borderRadius } : {}}
          ...
          <PaperDrawer.Item
            ...
            onPress={() => props.navigation.navigate('ExistingContract')}
          />
        </PaperDrawer.Section>
