...
<View style={styles.header}>
  ...
  <Text style={{alignSelf:'center', fontSize:18 , fontWeight:'bold' ,marginBottom:20,marginTop:20}}>แก้ไขลูกค้า</Text>
  ...
  />
  <TouchableOpacity
    disabled={!getValues('customer.name') || !getValues('customer.address')}
    onPress={handleSubmit(onSubmit)}
    style={[
      styles.button,
      (!getValues('customer.name') || !getValues('customer.address')) && styles.buttonDisabled
    ]}
  >
